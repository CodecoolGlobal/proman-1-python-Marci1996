...
function boardBuilder(board) {
    return `<div class="board-container" id=${board.id}>
                ...
                <button class="New-card-btn" id="newcardbtn${board.id}">New Card</button>
                <input style="display: none" id="newcard${board.id}">
                <button style="display: none" id="savecardbtn${board.id}">Save Card</button>
            </div>`;
}
